...
export const ActionType = {
  ...
  UPDATE_OFFER_FULFILLED: `app/update-offer_${Status.FULFILLED}`,
  UPDATE_OFFER_REJECTED: `app/update-offer_${Status.REJECTED}`,
...
export const updateOfferFulfilled = (offer) => ({
